    ...
    const complex_float * y)
{
    ...
    const xtfloatx2 * restrict pY = (const xtfloatx2*)(y + 7);
    const xtfloatx2 * restrict pD = (const xtfloatx2*)(D + 7);
    xtfloatx2 * restrict pX = (xtfloatx2*)(x + 7);
    xtfloatx2 D0;
    xtfloatx2 R1, R2, R3, R4, R5, R6, R7;
    ...
    XT_LSX2XP(R2, pR2, -SZ_CF32 * 7); // N-1
    ...
    XT_LSX2XP(R3, pR3, -SZ_CF32 * 7);
    XT_MADDMUX_S(X3, X0, R3, 2);
    XT_MADDMUX_S(Xt, X0, R3, 3);
    XT_LSX2XP(R3, pR3, -SZ_CF32 * 6);
    ...
    XT_LSX2XP(R6, pR6, -SZ_CF32 * 4);
    XT_MADDMUX_S(X6, X3, R6, 2);
    XT_MADDMUX_S(Xt, X3, R6, 3);
    XT_LSX2XP(R6, pR6, -SZ_CF32 * 3);
    ...
    XT_LSX2XP(R7, pR7, -SZ_CF32 * 3);
    XT_MADDMUX_S(X7, X4, R7, 2);
    XT_MADDMUX_S(Xt, X4, R7, 3);
    XT_LSX2XP(R7, pR7, -SZ_CF32 * 2);

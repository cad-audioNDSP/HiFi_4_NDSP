    ...
    const complex_float* restrict Z)
{
    ...
    int n, m;
    xtfloatx2 R0, D0;
    xtfloatx2 Yr0, Yr1, Yr2, Yr3, Yr4;
    xtfloatx2 Yw0, Yw1, Yw2, Yw3, Yw4;
    xtfloatx2 Yw0t, Yw1t, Yw2t, Yw3t, Yw4t;
    xtfloatx2 * restrict pY;
        ...
        //for (p = 0; p<P; p++)
    {
        ...
        tpR = pR;
        Yw0t = Yw1t = Yw2t = Yw3t = Yw4t = XT_CONST_S(0);
        for (m = 0; m < n; m++)
        {
        ...
        XT_LSX2XP(Yw2, pA, 10 * SZ_CF32);
        XT_LSX2XP(Yw3, pA, 10 * SZ_CF32);
        XT_LSX2XP(Yw4, pA, (-10 * 9 + 1)*SZ_CF32);
        Yw0 = XT_CONJC_S(Yw0);
        Yw1 = XT_CONJC_S(Yw1);
        Yw2 = XT_CONJC_S(Yw2);
        Yw3 = XT_CONJC_S(Yw3);
    ...
    const complex_float* restrict y)
{
    ...
    const xtfloatx2 * restrict pY = (xtfloatx2*)(y + (10 * 10 - 1));
    xtfloatx2 X0, X1, X2, X3, X4;
    xtfloatx2 Xw0, Xw1, Xw2, Xw3, Xw4;
    xtfloatx2 Xw0t, Xw1t, Xw2t, Xw3t, Xw4t;
    xtfloatx2 R0, D0;
    ...
    for (k = 10 - 1; k >= 0; k--)
    {
        ...
        {
            //p = 9..5
            pX = (xtfloatx2*)(x + 10 * 10 - 1); // last element in X
            ...
            Xw0t = Xw1t = Xw2t = Xw3t = Xw4t= XT_CONST_S(0);
            for (m = 0; m < 10 - k - 1; m++)
            {

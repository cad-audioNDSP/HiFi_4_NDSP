	...
	const complex_float * B)
{
	...
	for (m = 0; m<6; m++)
	{
		...
		XT_LSX2IP(A4, pA, SZ_CF32);
		XT_LSX2IP(A5, pA, SZ_CF32);
		...
		XT_MADDMUX_S(Z4, A4, B0, 0);
		XT_MADDMUX_S(Z4t, A4, B0, 3);
		XT_MADDMUX_S(Z5, A5, B0, 0);
		XT_MADDMUX_S(Z5t, A5, B0, 3);
	}
	...
	XT_SSX2IP(Z4, pZ, SZ_CF32);
	XT_SSX2IP(Z5, pZ, SZ_CF32);
}
/*-------------------------------------------------------------------------

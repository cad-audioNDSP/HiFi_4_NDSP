    ...
    for (m = 0; m < 6; m += 2)
    {
        ...
        for (n = m; n < 6; n += 2)
        {
            ...
            for (p = 0; p < 6; p++)
            {
                ...
                XT_LSX2IP(Apm1, pApm, (6 - 1)*SZ_CF32);
                XT_LSX2IP(Apn0, pApn, SZ_CF32);
                XT_LSX2IP(Apn1, pApn, (6 - 1)*SZ_CF32);
            ...
            XT_SSX2IP(Acc01, pRv0, (6 - 1)*SZ_CF32);
            XT_SSX2IP(Acc10, pRv0, SZ_CF32);
            XT_SSX2XP(Acc11, pRv0, -(6 - 1)*SZ_CF32);
            XT_SSX2IP(XT_CONJC_S(Acc00), pRh0, SZ_CF32);
            XT_SSX2IP(XT_CONJC_S(Acc10), pRh0, (6 - 1)*SZ_CF32);
            XT_SSX2IP(XT_CONJC_S(Acc01), pRh0, SZ_CF32);
            XT_SSX2IP(XT_CONJC_S(Acc11), pRh0, (6 - 1)*SZ_CF32);

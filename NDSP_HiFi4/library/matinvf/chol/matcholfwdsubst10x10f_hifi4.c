...
static void realcomputeAB10f(float32_t* Z, const float32_t* A, const float32_t* B)
{
	...
	for (m = 0; m<5; m++)
	{
		XT_LSX2IP(A0, pA, 2 * SZ_F32);
		XT_LSX2IP(A1, pA, 2 * SZ_F32);
		XT_LSX2IP(A2, pA, 2 * SZ_F32);
		XT_LSX2IP(A3, pA, 2 * SZ_F32);
		XT_LSX2IP(A4, pA, 2 * SZ_F32);
		_L32_SX2_IP(B0, pB, SZ_F32);
		XT_MADD_SX2(Z0, A0, B0);
		XT_MADD_SX2(Z1, A1, B0);
		XT_MADD_SX2(Z2, A2, B0);
		XT_MADD_SX2(Z3, A3, B0);
		XT_MADD_SX2(Z4, A4, B0);
		...
		XT_LSX2IP(A4, pA, 2 * SZ_F32);
		_L32_SX2_IP(B0, pB, SZ_F32);
		XT_MADD_SX2(Z0t, A0, B0);
		XT_MADD_SX2(Z1t, A1, B0);
		XT_MADD_SX2(Z2t, A2, B0);
		XT_MADD_SX2(Z3t, A3, B0);
		XT_MADD_SX2(Z4t, A4, B0);
	}
	...
	XT_SSX2IP(Z0, pZ, 2 * SZ_F32);
	XT_SSX2IP(Z1, pZ, 2 * SZ_F32);
	XT_SSX2IP(Z2, pZ, 2 * SZ_F32);
	XT_SSX2IP(Z3, pZ, 2 * SZ_F32);
	XT_SSX2IP(Z4, pZ, 2 * SZ_F32);

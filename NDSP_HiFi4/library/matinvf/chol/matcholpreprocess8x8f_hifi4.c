    ...
    const float32_t  sigma2)
{
    ...
    for (m = 0; m < 8; m += 2)
    {
        ...
        for (n = m; n < 8; n += 2)
        {
            ...
            //for (p = 0; p < 4; p++)
            {
                _L32_SX2_XP(Apm0, pApm0, 8 * SZ_F32);
                _L32_SX2_XP(Apm1, pApm1, 8 * SZ_F32);
                XT_LSX2IP(Apn01, pApn, 8 * SZ_F32);
                ...
                _L32_SX2_XP(Apm0, pApm0, -(7 * 8) * SZ_F32);
                _L32_SX2_XP(Apm1, pApm1, -(7 * 8) * SZ_F32);
                XT_LSX2XP(Apn01, pApn, -(7 * 8 - 2) * SZ_F32);
            ...
            XT_SSX2IP(Acc0, pRv0, 8 * SZ_F32);
            XT_SSX2XP(Acc1, pRv0, -(8 - 2) * SZ_F32);
            XT_SSX2IP(XT_SEL32_HH_SX2(Acc0, Acc1), pRh0, 8 * SZ_F32);
            XT_SSX2IP(XT_SEL32_LL_SX2(Acc0, Acc1), pRh0, 8 * SZ_F32);

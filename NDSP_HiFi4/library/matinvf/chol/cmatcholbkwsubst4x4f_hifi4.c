    ...
    const complex_float * y)
{
    ...
    const xtfloatx2 * restrict pY = (const xtfloatx2*)(y + 3);
    const xtfloatx2 * restrict pD = (const xtfloatx2*)(D + 3);
    xtfloatx2 * restrict pX = (xtfloatx2*)(x + 3);
    xtfloatx2 D0;
    xtfloatx2 R1, R2, R3;
    ...
    XT_LSX2XP(R2, pR2, -SZ_CF32 * 3); // N-1
    ...
    XT_LSX2XP(R3, pR3, -SZ_CF32 * 3);
    XT_MADDMUX_S(X3, X0, R3, 2);
    XT_MADDMUX_S(Xt, X0, R3, 3);
    XT_LSX2XP(R3, pR3, -SZ_CF32 * 2);

    ...
    const float32_t* restrict Z)
{
    ...
    {
        pY = (xtfloatx2*)y;
        XT_LSXP(Yw0, pA, 8 * SZ_F32);
        XT_LSXP(Yw1, pA, 8 * SZ_F32);
        XT_LSXP(Yw2, pA, 8 * SZ_F32);
        XT_LSXP(Yw3, pA, 8 * SZ_F32);
        XT_LSXP(Yw4, pA, 8 * SZ_F32);
        XT_LSXP(Yw5, pA, 8 * SZ_F32);
        XT_LSXP(Yw6, pA, 8 * SZ_F32);
    ...
    const float32_t* restrict y)
{
    ...
    const xtfloatx2 * restrict pY = (xtfloatx2*)(y + (8 * 8 - 2));
    ...
    {
        {
            pX = (xtfloatx2*)(x + 8 * 8 - 2); // last 2 elements in X

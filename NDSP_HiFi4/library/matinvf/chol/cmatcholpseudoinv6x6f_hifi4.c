    ...
    const complex_float* restrict Z)
{
        ...
        //for (p = 0; p<P; p++)
    {
        ...
        Yw0t = Yw1t = Yw2t = Yw3t = Yw4t = Yw5t = XT_CONST_S(0);
        for (m = 0; m < n; m++)
        {
            ...
            XT_LSX2IP(Yr4, pY, SZ_CF32);
            XT_LSX2IP(Yr5, pY, SZ_CF32);
            XT_LSX2IP(R0, pR, SZ_CF32);
            ...
            XT_MADDMUX_S(Yw4, R0, Yr4, 2);
            XT_MADDMUX_S(Yw4t, R0, Yr4, 1);
            XT_MADDMUX_S(Yw5, R0, Yr5, 2);
            XT_MADDMUX_S(Yw5t, R0, Yr5, 1);
        }
        Yw0 = XT_ADD_SX2(Yw0, Yw0t);
        Yw1 = XT_ADD_SX2(Yw1, Yw1t);
        Yw2 = XT_ADD_SX2(Yw2, Yw2t);
        Yw3 = XT_ADD_SX2(Yw3, Yw3t);
        Yw4 = XT_ADD_SX2(Yw4, Yw4t);
        Yw5 = XT_ADD_SX2(Yw5, Yw5t);
    ...
    const complex_float* restrict y)
{
    ...
    const xtfloatx2 * restrict pY = (xtfloatx2*)(y + (6 * 6 - 1));
    ...
    for (k = 6 - 1; k >= 0; k--)
    {
        //for (p = 0; p < P; p++)
        {
            pX = (xtfloatx2*)(x + 6 * 6 - 1); // last element in X
            pR = (xtfloatx2*)(tpR--); //points to the end of row k in R
            XT_LSX2XP(Xw5, pY, -SZ_CF32);
            XT_LSX2XP(Xw4, pY, -SZ_CF32);
            XT_LSX2XP(Xw3, pY, -SZ_CF32);
            XT_LSX2XP(Xw2, pY, -SZ_CF32);
            XT_LSX2XP(Xw1, pY, -SZ_CF32);
            XT_LSX2XP(Xw0, pY, -SZ_CF32);

            Xw0t = Xw1t = Xw2t = Xw3t = Xw4t = Xw5t = XT_CONST_S(0);
            for (m = 0; m < 6 - k - 1; m++)
            {
                XT_LSX2XP(X5, pX, -SZ_CF32);
                XT_LSX2XP(X4, pX, -SZ_CF32);
                ...
                XT_MADDMUX_S(Xw4, X4, R0, 2);
                XT_MADDMUX_S(Xw4t, X4, R0, 3);
                XT_MADDMUX_S(Xw5, X5, R0, 2);
                XT_MADDMUX_S(Xw5t, X5, R0, 3);
            }
            Xw0 = XT_ADD_SX2(Xw0, Xw0t);
            Xw1 = XT_ADD_SX2(Xw1, Xw1t);
            Xw2 = XT_ADD_SX2(Xw2, Xw2t);
            Xw3 = XT_ADD_SX2(Xw3, Xw3t);
            Xw4 = XT_ADD_SX2(Xw4, Xw4t);
            Xw5 = XT_ADD_SX2(Xw5, Xw5t);
            ...
            Xw4 = XT_MUL_SX2(Xw4, D0);
            Xw5 = XT_MUL_SX2(Xw5, D0);

            XT_SSX2XP(Xw5, pX, -SZ_CF32);
            XT_SSX2XP(Xw4, pX, -SZ_CF32);

...
{
#define N 10
    ae_int64 * restrict pZ = (ae_int64 *)Z;
    ...
    for (n = 0; n<N; n += 2)
    {
        ...
        AE_S64_IP(B_re0, pZ, sizeof(ae_int64));
        AE_S64_IP(B_re1, pZ, sizeof(ae_int64));
    }
#undef N
}
...
#define N 10
    ...
    for (n = 0; n<N; n += 2)
    {
        ...
        B_re0 = B_re1 = 0;
        R += n;
        AE_L64_IP(B_re0, pZ, sizeof(ae_int64));
        AE_L64_IP(B_re1, pZ, sizeof(ae_int64));

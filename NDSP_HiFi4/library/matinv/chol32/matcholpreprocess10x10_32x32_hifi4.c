...
#define N 10
    ...
    for (m = 0; m<N; m += 2)
    {
        ...
        for (n = m; n < N; n += 2)
        {
            ...
            AE_S64_I(B_re01, pZ0, 1 * sizeof(ae_int64));
            AE_S64_X(B_re10, pZ0, N*sizeof(ae_int64));
            AE_S64_X(B_re11, pZ0, (N + 1)*sizeof(ae_int64));
            AE_S64_IP(B_re00, pZ0, 2 * sizeof(ae_int64));

            AE_S64_I(B_re10, pZ1, 1 * sizeof(ae_int64));
            AE_S64_X(B_re01, pZ1, N * sizeof(ae_int64));
            AE_S64_X(B_re11, pZ1, (N + 1) * sizeof(ae_int64));
            AE_S64_XP(B_re00, pZ1, 2 * N*sizeof(ae_int64));
            B_re00 = B_re11 = 0;
        }
    }
#undef N

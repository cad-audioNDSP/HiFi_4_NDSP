...
#else
{
    ...
    if (N&1)
    {
        AE_L64_IP(A_re,castxcc(ae_int64,Z),sizeof(int64_t));
        AE_L64_IP(A_im,castxcc(ae_int64,Z),sizeof(int64_t));
        d_exp=D[1];
    ...
    for(n=(N&1); n<N; n+=2)
    {
        ...
        R+=2*n;
        AE_L64_IP(B0_re,castxcc(ae_int64,Z),sizeof(int64_t));
        AE_L64_IP(B0_im,castxcc(ae_int64,Z),sizeof(int64_t));
        AE_L64_IP(B1_re,castxcc(ae_int64,Z),sizeof(int64_t));
        AE_L64_IP(B1_im,castxcc(ae_int64,Z),sizeof(int64_t));

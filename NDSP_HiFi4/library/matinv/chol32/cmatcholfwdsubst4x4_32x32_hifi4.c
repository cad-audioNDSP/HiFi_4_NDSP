                         ...
                         int qYBRA)
{
    ...
    // compute A'*B
    {
        ...
        for(n=0; n<N; n+=2)
        {
            ...
            AE_L32X2_IP(areim0,castxcc(ae_int32x2,A),N*sizeof(ae_int32x2));
            ...
            AE_MULAAD32EP_HH_LL(ep_im0,B_im0,areim0,t);
            AE_MULAAD32EP_HH_LL(ep_im1,B_im1,areim1,t);
            AE_S64_IP(AE_SLAA64S(AE_SRAI72(ep_re0,B_re0,4),qYBRA+4),Z,sizeof(ae_int64));
            AE_S64_IP(AE_SLAA64S(AE_SRAI72(ep_im0,B_im0,4),qYBRA+4),Z,sizeof(ae_int64));
            AE_S64_IP(AE_SLAA64S(AE_SRAI72(ep_re1,B_re1,4),qYBRA+4),Z,sizeof(ae_int64));
            AE_S64_IP(AE_SLAA64S(AE_SRAI72(ep_im1,B_im1,4),qYBRA+4),Z,sizeof(ae_int64));
        }
    }
    Z=(ae_int64*)pScr;
    // forward recursion
    {
        ...
        for(n=0; n<N; n+=2)
        {
            ...
            R+=n;
            AE_L64_IP(B0_re,Z,sizeof(int64_t));
            AE_L64_IP(B0_im,Z,sizeof(int64_t));
            AE_L64_IP(B1_re,Z,sizeof(int64_t));
            AE_L64_IP(B1_im,Z,sizeof(int64_t));

...
#include "../vector/testeng_vector.h"
...
int accuracy_maths(int phaseNum, int isFull, int isVerbose, int breakOnError, int optAccuracy, int optException)
{
  int res = 1;
    ...
    if (optAccuracy)
    {
        ...
        */
        if ( phaseNum == 0 || phaseNum == 2 )
        {
            ...
            DO_TEST_ACC( &scl_sigmoidf      , "accuracy_scl_sigmoidf.seq"        , 0 );
        }

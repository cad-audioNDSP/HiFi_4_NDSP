...
#define PROFILE_RFFT_INPL(cond,verb,fun,N,suffix1,suffix2,suffix3, ...)           PROFILE_INVERTED(cond,verb,fun,(mips.out0.suffix2, mips.out0.suffix1,mips.inp1.suffix3,1,N), \
                                                                 fout,"N=" #N " [inplace]",prf_ptscycle3,(N));
#define PROFILE_RFFT_SCL(cond,verb,fun,N,suffix1,suffix2,suffix3,scl_mtd)       { int bexp; \
                                                PROFILE_INVERTED(cond,verb,fun,(mips.out1.suffix2,mips.inp0.suffix1,mips.inp1.suffix3,1,N,&bexp,scl_mtd), \
                                                                 fout,"N=" #N " [scl=" #scl_mtd "]", prf_ptscycle3,(N)) };
#define PROFILE_RFFT_SCL_INPL(cond,verb,fun,N,suffix1,suffix2,suffix3,scl_mtd)  { int bexp; \
                                                PROFILE_INVERTED(cond,verb,fun,(mips.out0.suffix2,mips.out0.suffix1,mips.inp1.suffix3,1,N,&bexp,scl_mtd), \
...
void mips_rfftie(int phaseNum, int isFull, int isVerbose, FILE * fout)
{
    /*  Stage 1*/

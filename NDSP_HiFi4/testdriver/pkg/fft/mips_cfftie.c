...
#define PROFILE_CFFT_INPL(cond,verb,fun,N,suffix, ...)           PROFILE_INVERTED(cond,verb,fun,(mips.out0.suffix,mips.out0.suffix,mips.inp1.suffix,1,N), \
...
#define PROFILE_CFFT_SCL_INPL(cond,verb,fun,N,suffix,scl_mtd)  { int bexp; \
                                                PROFILE_INVERTED(cond,verb,fun,(mips.out0.suffix,mips.out0.suffix,mips.inp1.suffix,1,N,&bexp,scl_mtd), \
...
void mips_cfftie(int phaseNum, int isFull, int isVerbose, FILE* fout)
{

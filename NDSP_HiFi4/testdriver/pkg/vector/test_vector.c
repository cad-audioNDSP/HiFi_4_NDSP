...
static void te_processFxn_vec_dot_batch( tTestEngContext * context )
{
    ...
    if(pApi->fmtX==(FMT_REAL|FMT_FLOAT32))
    {
...
testDefTbl[] =
{
  ...
  {
    FUNC_LIST( (tTestEngTarget)&vec_dot64x64, (tTestEngTarget)&vec_dot64x64_fast,
                (tTestEngTarget)&vec_dot64x64i,(tTestEngTarget)&vec_dot64x64i_fast),
...
int main_vector( int phaseNum, int isFull, int isVerbose, int breakOnError )
{
  int res = 1;

...
void mips_cchol2( int phaseNum, int isFull, int isVerbose, FILE* fout )
{
...
void mips_rchol2( int phaseNum, int isFull, int isVerbose, FILE* fout )
{
    if (phaseNum == 0 || phaseNum == 2)
    {
#if TEST_REAL
...
void mips_chol( int phaseNum, int isFull, int isVerbose, FILE* fout )
{
    mips_cchol2(phaseNum, isFull, isVerbose, fout );
    mips_rchol2(phaseNum, isFull, isVerbose, fout );
}

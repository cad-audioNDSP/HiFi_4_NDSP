...
void mfcc32x32_genWindow_cbk( void * host, fract32  * window, int len )
{
    (void)host; (void)window; (void)len;
}

/* STFT weighting window generator callback function. */
void mfccf_genWindow_cbk( void * host, float32_t * window, int len )
{
    (void)host; (void)window; (void)len;
}

/* Real-to-complex FFT callback function. */
int mfcc32x32_rfft_cbk( void * host, complex_fract32 * restrict y, fract32 * restrict x, int fftSize )
{
    int hidx;
...
/* Real-to-complex FFT callback function. */
void mfccf_rfft_cbk( void * host, complex_float * restrict y, float32_t * restrict x, int fftSize )
{
    (void)host;
...
void mips_mfcc(int phaseNum, int isFull, int isVerbose, FILE * fout)
{

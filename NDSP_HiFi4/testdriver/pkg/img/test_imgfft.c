...
/* FFT test target */
typedef void(*__tFrwTransFxn)(const void * x, void * y, const void * twdTbl,
                            int twdStep, int N, int * bexp, int scl_mtd);
typedef void(*__tInvTransFxn)(const void * x, void * y, const void * twdTbl,
                            int twdStep, int N, int * bexp, int scl_mtd);

typedef struct tagTestEngDesc_fft
{
    tTestEngDesc desc;
    __tFrwTransFxn frwTransFxn;  /* Forward transform function */
    __tInvTransFxn invTransFxn;  /* Inverse transform function */
...
#define TEST_DESC_BRFFT_NOSCALING( fmt,fwdfft,invfft )   {{ (fmt),TE_FFT_REAL|TE_FFT_BLOCKWISE|TE_FFT_NOSCALING, NULL, TE_ARGNUM_2,TE_ALIGN_YES,   \
    &te_create_fft, &te_destroy_fft, &te_load_fft, &fileProc_imgfft }, (__tFrwTransFxn)fwdfft, (__tInvTransFxn)invfft}
...
#define __MAX_DIM 640
    ...
    *vecGetElem_fl32(&context->dataSet.Z, 0) = -HUGE_VALF;
    ...
    NASSERT(strlen(context->seqDir) + 1 + strlen(context_fft->fInName) < sizeof(fInNameBuf));
    sprintf(fInNameBuf, "%s/%s", context->seqDir, context_fft->fInName);
    NASSERT(strlen(context->seqDir) + 1 + strlen(context_fft->fRefName) < sizeof(fRefNameBuf));
...
int main_imgfft( int phaseNum, int isFull, int isVerbose, int breakOnError )
{
    int res = 1;
    vecInitRegion(ALLOC_DRAM0);
    #define DO_TESTU8(fxn, seqFile)                                                                   \
    {                                                                                               \
        ...
        res &= (0 != TestEngRun(target, &desc.desc, seqFile, isFull, isVerbose, breakOnError, 0));  \
        if (!(res || !breakOnError))                                                                \
            return res;                                                                             \
    }
    #define DO_TESTS8(fxn, seqFile)                                                                   \
    {                                                                                               \
        tTestEngTarget     target = (tTestEngTarget)&te_frameProc_imgfft;                           \
    ...
    {
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_64x64.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_128x128.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_256x256.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_512x512.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_64x640.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_96x576.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_128x512.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_144x480.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_176x384.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_240x352.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_256x320.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_288x288.seq");       
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_640x64.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_576x96.seq");        
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_512x128.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_480x144.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_384x176.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_352x240.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_320x256.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_288x288.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_SQCIF.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_QCIF.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_QVGA.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_CIF.seq");
        DO_TESTU8 ( &imgfft_gu8,"imgfft_gu8_VGA.seq");

        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_64x64.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_128x128.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_256x256.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_512x512.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_64x640.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_96x576.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_128x512.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_144x480.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_176x384.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_240x352.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_256x320.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_288x288.seq");       
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_640x64.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_576x96.seq");        
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_512x128.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_480x144.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_384x176.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_352x240.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_320x256.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_288x288.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_SQCIF.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_QCIF.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_QVGA.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_CIF.seq");
        DO_TESTS8 ( &imgfft_gs8,"imgfft_gs8_VGA.seq");

        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_64x64.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_128x128.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_256x256.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_512x512.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_64x640.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_96x576.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_128x512.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_144x480.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_176x384.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_240x352.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_256x320.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_288x288.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_640x64.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_576x96.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_512x128.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_480x144.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_384x176.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_352x240.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_320x256.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_288x288.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_SQCIF.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_QCIF.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_QVGA.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_CIF.seq");
        DO_TEST16 ( &imgfft_gs16,"imgfft_gs16_VGA.seq");
     
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_64x64.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_128x128.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_256x256.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_512x512.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_64x640.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_96x576.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_128x512.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_144x480.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_176x384.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_240x352.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_256x320.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_288x288.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_640x64.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_576x96.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_512x128.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_480x144.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_384x176.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_352x240.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_320x256.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_288x288.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_SQCIF.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_QCIF.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_QVGA.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_CIF.seq");
        DO_TESTU8 ( &imgifft_gu8,"imgifft_gu8_VGA.seq");

        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_64x64.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_128x128.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_256x256.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_512x512.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_64x640.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_96x576.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_128x512.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_144x480.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_176x384.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_240x352.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_256x320.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_288x288.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_640x64.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_576x96.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_512x128.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_480x144.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_384x176.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_352x240.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_320x256.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_288x288.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_SQCIF.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_QCIF.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_QVGA.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_CIF.seq");
        DO_TESTS8 ( &imgifft_gs8,"imgifft_gs8_VGA.seq");

        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_64x64.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_128x128.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_256x256.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_512x512.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_64x640.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_96x576.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_128x512.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_144x480.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_176x384.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_240x352.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_256x320.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_288x288.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_640x64.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_576x96.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_512x128.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_480x144.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_384x176.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_352x240.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_320x256.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_288x288.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_SQCIF.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_QCIF.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_QVGA.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_CIF.seq");
        DO_TEST16 ( &imgifft_gs16,"imgifft_gs16_VGA.seq");
    }
#undef DO_TESTU8
#undef DO_TESTS8
#undef DO_TEST16

...
void mips_matinv(int phaseNum, int isFull, int isVerbose, FILE * fout)
{
    int i;
    ...
    if ( phaseNum == 0 || phaseNum == 2 )
    {
        ...
        PROFILE_MATINV(isFull, isVerbose, mtx_inv6x6f,4,f32);
        PROFILE_MATINV(     1, isVerbose, mtx_inv8x8f,4,f32);
        PROFILE_MATINV(isFull, isVerbose, mtx_inv10x10f,4,f32);
    }
} /* mips_matinv() */

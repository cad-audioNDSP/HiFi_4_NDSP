...
#define TE_FIR_OLDGENERIC   0x10 /* legacy API (generic filters)*/
#define TE_FIR_OLDEXTIR     0x20 /* legacy API (filters with external IR) */
#define TE_FIR_OLDDECIMATOR 0x40 /* legacy API (decimator/interpolator) */
